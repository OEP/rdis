"""
__Create_Wander_post_MDL.py_____________________________________________________

Automatically generated AToM3 Model File (Do not modify directly)
Author: pkilgo
Modified: Wed May  9 10:40:48 2012
...
def Create_Wander_post_MDL(self, rootNode, GenericGraphRootNode=None, RDISRootNode=None, ROSAppRootNode=None):

    # --- Generating attributes code for ASG GenericGraph ---
    ...
    # angular
    self.obj65.angular.setValue('<angular[0]>')

    # linear
    self.obj65.linear.setValue('<linear[0]>')
    ...
    if self.genGraphics:
       new_obj = graph_RangeAdapter(180.0,240.0,self.obj77)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_connectionTerminate(328.5,262.5,self.obj92)
       new_obj.DrawObject(self.UMLmodel)
    ...
    # data
    self.obj111.data.setValue('<distance == 0>')
    ...
    self.obj287=GenericGraphEdge(self)
    self.obj287.isGraphObjectVisual = True

    if(hasattr(self.obj287, '_setHierarchicalLink')):
      self.obj287._setHierarchicalLink(False)

    self.obj287.graphClass_= graph_GenericGraphEdge
    if self.genGraphics:
       new_obj = graph_GenericGraphEdge(310.714749458,446.490246612,self.obj287)
       new_obj.DrawObject(self.UMLmodel)
    ...
    self.obj288=GenericGraphEdge(self)
    self.obj288.isGraphObjectVisual = True

    if(hasattr(self.obj288, '_setHierarchicalLink')):
      self.obj288._setHierarchicalLink(False)

    self.obj288.graphClass_= graph_GenericGraphEdge
    if self.genGraphics:
       new_obj = graph_GenericGraphEdge(155.558506543,444.024546125,self.obj288)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("GenericGraphEdge", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj66,self.obj92,[172.0, 160.0, 328.5, 262.5],"true", 2) )
...
(self.obj75,self.obj84,[630.0, 361.0, 714.5, 361.5],"true", 2) )
    ...
    self.drawConnections(
(self.obj77,self.obj94,[183.0, 272.0, 181.2039332089999, 257.96383117852264, 170.983933209, 266.530471179],"true", 3) )
...
(self.obj78,self.obj93,[158.59760000000006, 395.0, 316.96434444291424, 389.13387826170583, 381.42976876299997, 300.13387826200005],"true", 3) )
    ...
    self.drawConnections(
(self.obj79,self.obj287,[139.0, 295.0, 310.7147494580814, 446.4902466119463], 0, 2) )
...
(self.obj91,self.obj72,[308.498736259, 128.442955327, 346.6816755442985, 181.81215532665448, 413.0, 143.0],"true", 3) )
    ...
    self.drawConnections(
(self.obj92,self.obj75,[328.5, 262.5, 533.0, 363.0],"true", 2) )
...
(self.obj93,self.obj73,[381.42976876299997, 300.13387826200005, 445.89519308291426, 211.1338782617059, 413.45929728, 223.0],"true", 3) )
    ...
    self.drawConnections(
(self.obj94,self.obj79,[170.983933209, 266.530471179, 160.76393320899996, 275.09711117852265, 139.0, 295.0],"true", 3) )
...
(self.obj109,self.obj288,[275.0, 511.0, 155.558506543243, 444.0245461252534],"true", 2) )
...
(self.obj113,self.obj112,[290.5, 469.0, 322.0, 506.0],"true", 2) )
    # Connections for obj287 (graphObject_: Obj193) of type GenericGraphEdge
    self.drawConnections(
(self.obj287,self.obj110,[310.7147494580814, 446.4902466119463, 393.4647494580814, 525.4902466119463, 470.0, 611.0],"true", 3) )
    # Connections for obj288 (graphObject_: Obj194) of type GenericGraphEdge
    self.drawConnections(
(self.obj288,self.obj78,[155.558506543243, 444.0245461252534, 152.808506543243, 420.0245461252534, 159.0, 395.0],"true", 3) )

newfunction = Create_Wander_post_MDL

loadedMMName = ['GenericGraph', 'RDIS_META', 'ROSApp_META']
