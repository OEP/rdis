"""
__graph_ROSSubscribe.py___________________________________________________________

Automatically generated LINK for entity ROSSubscribe
...
class graph_ROSSubscribe(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('ROSSubscribe_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('ROSSubscribe_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('ROSSubscribe_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('ROSSubscribe_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('ROSSubscribe_2ndLink', self.le.SecondLink))
