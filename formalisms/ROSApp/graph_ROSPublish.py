"""
__graph_ROSPublish.py___________________________________________________________

Automatically generated LINK for entity ROSPublish
...
class graph_ROSPublish(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('ROSPublish_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('ROSPublish_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('ROSPublish_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('ROSPublish_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('ROSPublish_2ndLink', self.le.SecondLink))
