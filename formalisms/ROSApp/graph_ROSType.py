"""
__graph_ROSType.py___________________________________________________________

Automatically generated LINK for entity ROSType
...
class graph_ROSType(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('ROSType_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('ROSType_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('ROSType_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('ROSType_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('ROSType_2ndLink', self.le.SecondLink))
