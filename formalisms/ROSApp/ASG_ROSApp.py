"""
__ASG_ROSApp.py_____________________________________________________
...
class ASG_ROSApp(ASG, ATOM3Type):

   def __init__(self, parent= None, ASGroot = None):
      ASG.__init__(self, 'ROSApp', ASGroot, ['ASG_ROSApp' ,'ROSNode' ,'ROSTopic' ,'ROSMessage' ,'ROSTwist' ,'ROSBoolean' ,'ROSPublish' ,'ROSSubscribe' ,'ROSType'])
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'ROSApp', 0, 1, self)
