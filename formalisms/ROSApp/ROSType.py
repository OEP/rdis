"""
__ROSType.py_____________________________________________________
...
class ROSType(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_ROSType
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = ROSType( self.parent )
