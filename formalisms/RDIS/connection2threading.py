"""
__connection2threading.py_____________________________________________________
...
class connection2threading(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_connection2threading
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = connection2threading( self.parent )
