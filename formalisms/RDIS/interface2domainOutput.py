"""
__interface2domainOutput.py_____________________________________________________
...
class interface2domainOutput(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_interface2domainOutput
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = interface2domainOutput( self.parent )
