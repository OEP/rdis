"""
__DomainInterface.py_____________________________________________________
...
class DomainInterface(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_DomainInterface
   ...
   def clone(self):
      cloneObject = DomainInterface( self.parent )
