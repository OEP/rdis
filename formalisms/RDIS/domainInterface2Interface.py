"""
__domainInterface2Interface.py_____________________________________________________
...
class domainInterface2Interface(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_domainInterface2Interface
      ...
      self.realOrder = ['arguments']
      self.directEditing = [1]
   def clone(self):
      cloneObject = domainInterface2Interface( self.parent )
