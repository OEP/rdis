"""
__graph_domainInterface2domainAdapter.py___________________________________________________________

Automatically generated LINK for entity domainInterface2domainAdapter
...
class graph_domainInterface2domainAdapter(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "domainInterface2domainAdapter")
      ...
      self.le.FirstLink.decoration.setValue( ('domainInterface2domainAdapter_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('domainInterface2domainAdapter_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('domainInterface2domainAdapter_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('domainInterface2domainAdapter_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('domainInterface2domainAdapter_2ndLink', self.le.SecondLink))
