"""
__graph_domainInterface2Interface.py___________________________________________________________

Automatically generated LINK for entity domainInterface2Interface
...
class graph_domainInterface2Interface(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "domainInterface2Interface")
      ...
      self.le.FirstLink.decoration.setValue( ('domainInterface2Interface_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('domainInterface2Interface_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('domainInterface2Interface_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('domainInterface2Interface_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('domainInterface2Interface_2ndLink', self.le.SecondLink))
