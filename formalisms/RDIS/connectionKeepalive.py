"""
__connectionKeepalive.py_____________________________________________________
...
class connectionKeepalive(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_connectionKeepalive
      ...
      self.interval=ATOM3Integer(0)
      self.generatedAttributes = {'arguments': ('ATOM3List', 'ATOM3String'),
                                  'interval': ('ATOM3Integer', )      }
      self.realOrder = ['arguments','interval']
      self.directEditing = [1,1]
   def clone(self):
      cloneObject = connectionKeepalive( self.parent )
