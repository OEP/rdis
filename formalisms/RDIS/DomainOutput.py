"""
__DomainOutput.py_____________________________________________________
...
class DomainOutput(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_DomainOutput
   ...
   def clone(self):
      cloneObject = DomainOutput( self.parent )
