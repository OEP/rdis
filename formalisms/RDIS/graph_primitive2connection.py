"""
__graph_primitive2connection.py___________________________________________________________

Automatically generated LINK for entity primitive2connection
...
class graph_primitive2connection(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "primitive2connection")
      ...
      self.le.FirstLink.decoration.setValue( ('primitive2connection_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('primitive2connection_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('primitive2connection_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('primitive2connection_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('primitive2connection_2ndLink', self.le.SecondLink))
