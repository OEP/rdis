"""
__graph_connection2threading.py___________________________________________________________

Automatically generated LINK for entity connection2threading
...
class graph_connection2threading(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "connection2threading")
      ...
      self.le.FirstLink.decoration.setValue( ('connection2threading_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('connection2threading_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('connection2threading_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('connection2threading_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('connection2threading_2ndLink', self.le.SecondLink))
