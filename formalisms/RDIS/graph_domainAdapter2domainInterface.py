"""
__graph_domainAdapter2domainInterface.py___________________________________________________________

Automatically generated LINK for entity domainAdapter2domainInterface
...
class graph_domainAdapter2domainInterface(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "domainAdapter2domainInterface")
      ...
      self.le.FirstLink.decoration.setValue( ('domainAdapter2domainInterface_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('domainAdapter2domainInterface_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('domainAdapter2domainInterface_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('domainAdapter2domainInterface_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('domainAdapter2domainInterface_2ndLink', self.le.SecondLink))
