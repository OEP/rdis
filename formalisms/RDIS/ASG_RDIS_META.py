"""
__ASG_RDIS_META.py_____________________________________________________
...
class ASG_RDIS_META(ASG, ATOM3Type):
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'RDIS_META', 0, 1, self)
