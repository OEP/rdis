"""
__domainInterface2domainAdapter.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: pkilgo
Modified: Wed Apr 11 19:57:24 2012
...
from graph_domainInterface2domainAdapter import *
class domainInterface2domainAdapter(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_domainInterface2domainAdapter
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = domainInterface2domainAdapter( self.parent )
