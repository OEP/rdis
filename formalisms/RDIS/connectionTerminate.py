"""
__connectionTerminate.py_____________________________________________________
...
class connectionTerminate(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_connectionTerminate
   ...
   def clone(self):
      cloneObject = connectionTerminate( self.parent )
