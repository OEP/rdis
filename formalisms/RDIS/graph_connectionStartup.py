"""
__graph_connectionStartup.py___________________________________________________________

Automatically generated LINK for entity connectionStartup
...
class graph_connectionStartup(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "connectionStartup")
      ...
      self.le.FirstLink.decoration.setValue( ('connectionStartup_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('connectionStartup_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('connectionStartup_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('connectionStartup_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('connectionStartup_2ndLink', self.le.SecondLink))
