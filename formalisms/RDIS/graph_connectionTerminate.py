"""
__graph_connectionTerminate.py___________________________________________________________

Automatically generated LINK for entity connectionTerminate
...
class graph_connectionTerminate(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "connectionTerminate")
      ...
      self.le.FirstLink.decoration.setValue( ('connectionTerminate_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('connectionTerminate_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('connectionTerminate_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('connectionTerminate_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('connectionTerminate_2ndLink', self.le.SecondLink))
