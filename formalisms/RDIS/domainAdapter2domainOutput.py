"""
__domainAdapter2domainOutput.py_____________________________________________________
...
class domainAdapter2domainOutput(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_domainAdapter2domainOutput
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = domainAdapter2domainOutput( self.parent )
