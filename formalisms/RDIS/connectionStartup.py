"""
__connectionStartup.py_____________________________________________________
...
class connectionStartup(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_connectionStartup
   ...
   def clone(self):
      cloneObject = connectionStartup( self.parent )
