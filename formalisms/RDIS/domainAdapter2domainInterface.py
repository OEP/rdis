"""
__domainAdapter2domainInterface.py_____________________________________________________
...
class domainAdapter2domainInterface(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_domainAdapter2domainInterface
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = domainAdapter2domainInterface( self.parent )
