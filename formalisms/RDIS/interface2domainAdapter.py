"""
__interface2domainAdapter.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: pkilgo
Modified: Sat Apr 14 17:12:09 2012
...
from graph_interface2domainAdapter import *
class interface2domainAdapter(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_interface2domainAdapter
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = interface2domainAdapter( self.parent )
