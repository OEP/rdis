"""
__graph_connectionKeepalive.py___________________________________________________________

Automatically generated LINK for entity connectionKeepalive
...
class graph_connectionKeepalive(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "connectionKeepalive")
      ...
      self.le.FirstLink.decoration.setValue( ('connectionKeepalive_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('connectionKeepalive_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('connectionKeepalive_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('connectionKeepalive_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('connectionKeepalive_2ndLink', self.le.SecondLink))
